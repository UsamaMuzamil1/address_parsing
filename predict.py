...
chunker = get_address_chunker('corpus/dataset/IOB_tagged_addresses.pkl')
# Copy your address here.
addresses = extract_address(chunker,
                            "City Glass,Faizan Street,Block E,North Nazimabad,Karachi,Sindh,")
print([" ".join(address) for address in addresses])

addresses1 = extract_address(chunker,
                            "Marhaba Bakers & Nimco,Allama Rasheed Turabi Road,Block N,North Nazimabad,Karachi,Sindh,")
print([" ".join(address) for address in addresses1])


addresses2 = extract_address(chunker,
                            "Noor E Syed Medical Store,Dr Sohail Haider Street,Block 19,Federal B Area (Gulberg),Karachi,Sindh,")
print([" ".join(address) for address in addresses2])


addresses3 = extract_address(chunker,
                            "Bismillah Enterprises & Marketing,Muhammad Hassan Road,Block N,North Nazimabad,Karachi,Sindh,")
print([" ".join(address) for address in addresses3])
